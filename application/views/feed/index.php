                    ...
                    <div class="col s12">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                <span class="card-title black-text">Bruce Banner Wayne</span>
                            </div>
                        </div>
                    </div>
                </div>
...
<div class="container">
    <div class="section">
        ...
        <div class="row">
            ...
            <!-- Card 1 // 이 모양으로 하나씩 추가 -->
            <div class="col s12 m4">
                <div class="card">
                    <div class="card-image waves-effect waves-block waves-light">
                        <img class="activator" src="/static/image/background1.jpg">
                    </div>
                    <div class="card-content">
